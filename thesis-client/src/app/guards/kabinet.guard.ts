...
@Injectable()
export class KabinetGuard implements CanActivate{
  ...
  canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): boolean | UrlTree | Observable<boolean | UrlTree> | Promise<boolean | UrlTree> {
    ...
    return isAuthenticated && (userData.permissions == 'elnokseg' || userData.permissions == 'admin' || userData.permissions == 'kabinet');
  }
